<?php
    ...
    $sql = "SELECT id, hotelroom, features, facilities, guests, price, promotion FROM hilton";
...
<html lang="en">
    <head>
        ...
        <title>My Hotel Booking - Hilton Rooms</title>
    ...
    <body>
        ...
        <div class="my-5 px-4">
            <h2 class="fw-bold h-font text-center">Hilton Hotel Rooms</h2>
            <p class="text-center ">
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo '<div class="row g-0 p-3 align-items-center">';
                                        echo '<div class="col-md-5 mb-lg-0 mb-md-0 mb-3">';
                                            echo  '<img src="images/rooms/hilton1.jpg" class="img-fluid rounded-start">';
                                        echo '</div>';
                                        ...
                                        echo'<div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">';
                                            ...
                                            echo '<a href="hiltonbooking.php?id='. $row['id'] .'" class="btn btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Now</a>';
                                        echo '</div>';
                                    echo '</div>';
                                }
                            }
